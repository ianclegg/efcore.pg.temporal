...
/// </summary>
public class NpgsqlTemporalQuerySqlGeneratorFactory : IQuerySqlGeneratorFactory
{
    ...
    /// </summary>
    public NpgsqlTemporalQuerySqlGeneratorFactory(
    ...
    public virtual QuerySqlGenerator Create()
        => new NpgsqlTemporalQuerySqlGenerator(
            _dependencies,
